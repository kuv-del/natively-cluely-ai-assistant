...
const Launcher: React.FC<LauncherProps> = ({ onStartMeeting, onOpenSettings, onOpenModes, onPageChange, ollamaPullStatus = 'idle', ollamaPullPercent = 0, ollamaPullMessage = '' }) => {
    ...
    const fetchMeetings = () => {
        // IPC handler merges local SQLite + Convex feed in the main process
                ...
                <AnimatePresence mode="wait">
                    {matriaEvent ? (
                        ...
                        >
                            ...
                            {/* TOP SECTION — hero header, then week view fills the rest */}
                            <section className="px-8 pt-6 pb-2 shrink-0" style={{ background: '#FDFDFA' }}>
                            ...
                            {/* Week View — fills remaining vertical space, with bottom padding */}
                            <div className="flex-1 min-h-0 px-4 pb-4" style={{ background: '#FDFDFA' }}>
                                <WeekView
                                    isLight={isLight}
                            ...
                            {/* Activity feed removed — moved out of launcher; will resurface elsewhere. */}
                        </motion.div>
                    )}
                </AnimatePresence>
            </div>
